...
DROPOUT_PROB = 0.1  # the chance of dropping out if the condition stated in the paper is met (f_{t,x,a} <= x/t)
DROPOUT_WEEK = 11  # the week AT THE END of which users may drop out
